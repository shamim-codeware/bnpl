                    ...
                    <div class="col-lg-12">
                        <div class="card card-default card-md mb-4">
                            ...
                            <div class="card-body py-md-30">
                                <form action="{{url('down-payment-settings/'.$downpayment->id)}}" method="post">
                                    @method('put')
                                    @csrf
                                    ...
                                    <div class="form-group row mb-n25">
                                        <div class="col-md-4 mb-25">
                                            <div class="with-icon">
                                                ...
                                                <input type="number" value="{{ $downpayment->payment_percentage }}" name="payment_percentage" class="form-control  ih-medium ip-lightradius-xs b-light" id="inputNameIcon1" >
                                            </div>
                                        </div>
