                        ...
                        <div class="card card-default card-md mb-4">
                            @if (Auth::user()->user_action(1))
                                <div class="card-header">
                                    <h6>Add Incentive Configuration</h6>
                                </div>
                                        ...
                                        <div class="form-group row mb-25">
                                            ...
                                            <div class="col-md-4 mb-25" id="category-selector">
                                                ...
                                                <div class="select-style2">
                                                    <div class="dm-select">
                                                        <select name="category_reference_id" id="select-category" class="form-control">
                                            ...
                                            <div class="col-md-4 mb-25" id="model-selector" style="display: none;">
                                                ...
                                                <div class="select-style2">
                                                    <div class="dm-select">
                                                        <select name="model_reference_id" id="select-model" class="form-control">
