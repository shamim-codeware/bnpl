                                    ...
                                    <form action="{{ url('banks') }}" method="post">
                                        ...
                                        <div class="form-group row mb-n25">
                                            <div class="col-md-4 mb-25">
                                                <div class="with-icon">
                                                    <input type="text" required name="name" class="form-control  ih-medium ip-lightradius-xs b-light" id="inputNameIcon1" placeholder="Bank Name">
                                                </div>
                                            </div>
                        ...
                        <div class="row row-cols-3 w-100">
                            ...
                            <div class="col d-flex justify-content-end "> <div class="support-form__search">
                                <div class="support-order-search">
                                    <form action="{{ url('/banks') }}" method="GET" class="support-order-search__form">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="orderDatatable_actions mb-0 d-flex justify-content-center align-items-center flex-wrap">
                                                ...
                                                <li>
                                                    <a href="{{url('banks/'.$item->id.'/edit')}}" class="edit">
