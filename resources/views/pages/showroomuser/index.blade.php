                        ...
                        <div class="col-lg-12">
                            <div class="card card-default card-md mb-4">
                                <div class="card-header">
                                    ...
                                    <a class="btn btn-primary" href="{{ url('show-room-user/create') }}">Add Sales Representative</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="orderDatatable_actions mb-0 d-flex justify-content-center align-items-center flex-wrap">
                                                        ...
                                                        <li>
                                                            <a data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="{{ url('show-room-user/' . $type->id.'/edit') }}" class="edit">
