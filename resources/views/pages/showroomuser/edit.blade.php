                        ...
                        <div class="col-lg-12">
                            <div class="card card-default card-md mb-4">
                                <div class="card-header">
                                    <h6>Edit Sales Representative</h6>
                                </div>
                                <div class="card-body py-md-30">
                                    ...
                                    @endif
                                    <form action="{{ route('show-room-user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                                        @method('put')
                                        @csrf 
                                        <div class="form-group row mb-n25">
                                            ...
                                            <div class="col-md-6">
                                                <div class="with-icon">
                                                    <div class="form-group form-group-calender mb-20">
                                                        <input required type="text" value="{{ $user->name }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="with-icon">
                                                    <div class="form-group form-group-calender mb-20">
                                                        <input required type="number" value="{{ $user->phone }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-15">
                                                    <div class="position-relative">
                                                        <input id="password-field" type="text" class="form-control" value="{{ $user->address }}"
