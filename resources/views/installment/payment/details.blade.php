<div class="col-md-5">
                ...
                <fieldset class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-25">
                            <input type="hidden" value="{{ $hirepurchase->id }}" name="hire_purchase_id" id="hire_purchase_id">
                            <input type="hidden" id="monthly_installment" value="{{ @$hirepurchase->purchase_product->monthly_installment }}" name="monthly_installment">
                            <select  onchange="CalculateAmount()" name="number_of_instllment" id="number_of_instllment" class="form-control">
                                <option value="">How many months are you accepting
                                    installments?</option>
                                    @php
                                        $remainingInstallments = App\Models\Installment::where('hire_purchase_id',$hirepurchase->id)->where('status',0)->count();
...
{{--                                    <option value="0">Others</option>--}}
                        ...
                        <div class="col-md-12 mb-25">
                            <div class="holder">
                                <div class="input-holder">
                                    <input readonly required="" name="amount" id="amount"
                                        class="input" type="text"
                                        placeholder=" " />
                                    <div class="placeholder">
                                        <p class="m-0">Receiving (BDT)<span
                            ...
                            <div class="select-style2">
                                <div class="form-control d-flex gap-3 align-items-center">
                                    <div class="d-flex align-items-center flex-nowrap gap-2"
                                        ><input checked name="payment_type" id="cus_showroom"
                                            value="1" type="radio" /> <label
                                            class="mt-0" for="cus_showroom">The customer comes
                                            to
                                            the showroom and makes the payment</label></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 mb-25">
                            <div class="select-style2">
                                <div class="form-control d-flex gap-3 align-items-center">
                                    <div class="d-flex align-items-center flex-nowrap gap-2"><input id="cus_house" name="payment_type" value="cus_house"
                                            type="radio" /> <label class="mt-0"
                                            for="2">Collection is being done by going to
                        ...
                        <div class="col-md-7 mb-25 pe-md-0">
                            ...
                            <button type="submit"
                                class="btn btn-lg btn-primary customr-btn btn-submit">Recive
                                Payment</button>
                        </div>
                ...
                Full payment for installment of product {{ @$hirepurchase->purchase_product->brand->name }} {{ @$hirepurchase->purchase_product->product->product_model }} from {{ @$hirepurchase->name  }}
            ...
            <div class="col-md-7" >
                <fieldset>
                    <legend>{{ @$hirepurchase->purchase_product->brand->name }} {{ @$hirepurchase->purchase_product->product->product_model }}</legend>
                    <div class="row">
                        ...
                        <div class="col-md-7 mb-15 text-end">
                            <span class="fw-medium">Total payment ({{ $hirepurchase->purchase_product->installment_month - 1 }} installments) to be made:</span>
                        </div>
                        <div class="col-md-5 mb-15">
                            <span>{{ $hirepurchase->purchase_product->hire_price - $hirepurchase->purchase_product->down_payment }}  TK</span>
                        </div>
                        {{-- <div class="col-md-7 mb-15 text-end">
                        ...
                        <div class="col-md-5 mb-15">
                            <span> {{ App\Models\Installment::where('hire_purchase_id',$hirepurchase->id)->where('status',0)->count()  }}</span>
                        </div>
                        ...
                        <div class="col-md-5 mb-15">
                            <span> {{ App\Models\Installment::where('hire_purchase_id',$hirepurchase->id)->where('status',0)->sum('amount') }} TK </span>
                        </div>
