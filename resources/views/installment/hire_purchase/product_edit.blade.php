...
@section('content')
    <div class="container-fluid">
        <div class="form-element">
            <form action="{{ url('hire-purchase-product-update/'.$query->id) }}" method="post" enctype="multipart/form-data" class="parent-assign">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <!-- Product Group -->
                                            <div class="col-md-3">
                                                <select required name="product_group_id" onchange="GetCategory()" id="group" class="form-control">
                                                    <option value="">Product Group</option>
                                                    @foreach ($product_type as $type)
                                                        <option value="{{ $type->id }}" {{ isset($hirepurchase_product) && $hirepurchase_product->product_group_id == $type->id ? 'selected' : '' }}>
                                                            {{ $type->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-3 mb-25">
                                                <div class="">
                                                    <div class="">
                                                        <select required name="product_category_id" id="Select-Model" class="form-control category">
                                                            @if(isset($hirepurchase_product) && $hirepurchase_product->product_category_id)
                                                                <option value="{{ $hirepurchase_product->product_category_id }}" selected>
                                            ...
                                            <!-- Product Brand -->
                                            <div class="col-md-3">
                                                <select required onchange="GetProduct()" name="product_brand_id" id="prod_brand" class="form-control">
                                                    <option value="">Product Brand</option>
                                                    @foreach ($brands as $brand)
                                                        <option value="{{ $brand->id }}" {{ isset($hirepurchase_product) && $hirepurchase_product->product_brand_id == $brand->id ? 'selected' : '' }}>
                                                            {{ $brand->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <!-- Product Model -->
                                            <div class="col-md-3">
                                                <select required onchange="GetPrice()" name="product_model_id" id="Select-color" class="form-control">
                                                    <option value="">Product Model:</option>
                                                    @if(isset($hirepurchase_product) && $hirepurchase_product->product_model_id)
                                                        <option value="{{ $hirepurchase_product->product_model_id }}" selected>
                                            ...
                                            <!-- Product Size -->
                                            <div class="col-md-3">
                                                 <input type="text" name="product_size_id" id="product_size" class="form-control" value="{{ $hirepurchase_product->product_size_id }}" placeholder="Product Size">
                                            </div>
                                            <!-- Serial Number -->
                                            <div class="col-md-3 mb-25">
                                                <div class="holder">
                                                    <div class="input-holder">
                                                        <input required name="serial_no" id="serial_no" class="input" type="text"
                                                               placeholder=" " value="{{ isset($hirepurchase_product) ? $hirepurchase_product->serial_no : '' }}" />
                                                        <div class="placeholder">
                                                            <p class="m-0">Serial No:<span class="text-danger">*</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-25">
                                                <div class="holder">
                                                    <div class="input-holder">
                                                        <input required name="cash_price" id="cash_price" class="input" readonly
                                                               type="number" placeholder=" " value="{{ isset($hirepurchase_product) ? $hirepurchase_product->cash_price : '' }}" />
                                                        <div class="placeholder">
                                                            <p class="m-0">Cash Price:<span class="text-danger">*</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-25">
                                                <div class="holder">
                                                    <div class="input-holder">
                                                        <select required onchange="calculate()" name="down_payment_parcentage" id="down_payment_parcentage" class="form-control">
                                                            @foreach ($down_payment_parcentage as $item)
                                                                <option value="{{ $item->payment_percentage }}"
                                                                    {{ (isset($hirepurchase_product) && $hirepurchase_product->down_payment_parcentage == $item->payment_percentage) ||
                                                                       (!isset($hirepurchase_product) && $item->payment_percentage == 40) ? 'selected' : '' }}>
                                                ...
                                                <div class="holder">
                                                    <div class="input-holder">
                                                        @foreach ($interestrate as $interest_hid)
                                                            <input type="hidden" id="interest_rate_{{ $interest_hid->month }}" value="{{ $interest_hid->interest_rate }}">
                                                        @endforeach
                                                        <select required onchange="calculate()" name="installment_month" id="installment_month" class="form-control">
                                            ...
                                            <div class="col-md-3 mb-25">
                                                <div class="holder">
                                                    <div class="input-holder">
                                                        <input onkeyup="calculate()" required name="hire_price" id="hire_price"
                                                               class="input" readonly type="text" placeholder=" "
                                                               value="{{ isset($hirepurchase_product) ? $hirepurchase_product->hire_price : '' }}" />
                                                        <div class="placeholder">
                                                            <p class="m-0">Hire Price:<span class="text-danger">*</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-25">
                                                <div class="holder">
                                                    <div class="input-holder">
                                                        <input required name="down_payment" id="down_payment" class="input" type="text"
                                                               placeholder=" " value="{{ isset($hirepurchase_product) ? $hirepurchase_product->down_payment : '' }}" />
                                                        <div class="placeholder">
                                                            <p class="m-0">Down Payment:<span class="text-danger">*</span></p>
                                                        </div>
                                            ...
                                            <div class="col-md-3 mb-25">
                                                <div class="holder">
                                                    <div class="input-holder">
                                                        <input required name="monthly_installment" id="monthly_inst" class="input"
                                                               type="text" placeholder=" " value="{{ isset($hirepurchase_product) ? $hirepurchase_product->monthly_installment : '' }}" />
                                                        <div class="placeholder">
                                                            <p class="m-0">Monthly Inst. Tk:<span class="text-danger">*</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button id="save_button" class="btn btn-lg btn-primary customr-btn btn-submit ms-auto" type="submit">
                                    Save And Continue
                                </button>
                            </div>
                        </div>
