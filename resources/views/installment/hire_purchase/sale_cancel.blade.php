...
@section('content')
    <div class="container-fluid">
        <div class="form-element">
            <form action="{{ url('cancel-action/'.$id) }}" method="post" enctype="multipart/form-data" class="parent-assign">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
...
{{--                                                           <option value="1">Full Cancel</option>--}}
{{--                                                           <option value="2">Partial Cancel</option>--}}
{{--                                                         </select>--}}
{{--                                                        <div class="placeholder">--}}
{{--                                                            <p class="m-0">Cancel Type :<span--}}
                                    ...
                                    <fieldset class="">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="holder">
                                                    <div class="input-holder">
                                                        <input required name="down_payment" id="down_payment" class="input"
                                                               value="{{ $order_info->down_payment }}" type="number" placeholder=" " />
                                                        <div class="placeholder">
                                                ...
                                                <div class="holder">
                                                    <div class="input-holder">
                                                        <input required name="instalments_rate" id="instalments_rate" class="input"
                                                               value="{{ @$order_info->instalments_rate }}" type="number" placeholder=" " />
                                                        <div class="placeholder">
                                            ...
                                            <div class="col-md-3 mb-25">
                                                <div class="holder">
                                                    <div class="input-holder">
                                                        <input required name="note" id="note" class="input"
                                                    ...
                                                    <div class="holder">
                                                        <div class="input-holder">
                                                            <input required name="unit_rate" id="unit_rate" class="input"
                                                                   value="{{ $item->unit_rate }}" type="number" placeholder=" " />
                                                            <div class="placeholder">
