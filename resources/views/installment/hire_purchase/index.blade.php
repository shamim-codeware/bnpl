...
@section('content')
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-25">
                                        <input type="text" name="order_no" id="order_no" class="form-control" placeholder="Order Number">
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <input type="hidden" value="{{ request()->over_dues }}" id="over_dues" >
    ...
    <script>
        ...
        function getData(page, event) {
            ...
            // Call
            $.ajax({
                    url: "{{ url('all-purchase-action?page=') }}" + page + "&" + paramStrings.join('&'),
                    type: "get",
                    datatype: "html",
                })
                .done(function(data) {
