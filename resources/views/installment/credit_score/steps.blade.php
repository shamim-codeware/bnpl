                    ...
                    <div class="card card-default card-md mb-4">
                        ...
                        <div class="card-body py-md-30">
                               ...
                               {{-- <div class="col-md-4 mb-25">
                                    ...
                                    <div class="col-md-4 mb-25">
                                        <select onchange="ReceivedSalesman()" required name="showroom_user_id" id="showroom_user_id" class="form-control">
                                            <option value="">Sales Representative</option>
                                            @foreach($showroomusers as $key=>$showroomuser)
                                               <option value="{{ $showroomuser->id }}">{{ $showroomuser->name }} - {{ $showroomuser->code }} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    {{-- <div class="col-md-4 mb-25">
                                ...
                                <table class="table pt-3 table-border credit_score_table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-start">
                                            ...
                                            <td>
                                                <input type="radio" name="bad_creditor" id="creditor_yes" value="1" />
                                            </td>
                                            <td>
                    ...
                    <div class="card card-default card-md mb-4" id="step_two_form" style="display: none">
                        ...
                        <div class="card-body py-md-30">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;">
                                                <select onchange="Calculate()" name="age" id="age" class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;padding-bottom:3px;">
                                                <select onchange="Calculate()" name="customer_status" id="customer_status" class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top:0;padding-bottom:0;">
                                                <small class="text_xs text-muted d-block text-start">(If old or previous customer then his
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;padding-bottom:3px;">
                                                <select onchange="Calculate()"  name="monthly_income" id="monthly_income" class="form-control">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td style="padding-top:0;padding-bottom:0;">
                                                <small class="text_xs text-muted d-block text-start">(Ratio of monthly installment to net
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;padding-bottom:3px;">
                                                <select onchange="Calculate()" name="profession" id="profession" class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top:0;padding-bottom:0;">
                                                <input type="text" id="otherProfession" name="other_profession" class="form-control"
                                                    style="display: none;" placeholder="Enter Other Profession">
                                            </td>
                                            <td style="padding: 0;"></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;">
                                                <select onchange="Calculate()" name="length_profession" id="prof_length" class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;">
                                                <select onchange="Calculate()" name="family_size" id="family_size" class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;">
                                                <select onchange="Calculate()" name="residence_status" id="res_status" class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;">
                                                <div class="select-style2">
                                                    <div style="height: 40px !important;" class="form-control d-flex gap-3 align-items-center">
                                                        <div class="d-flex align-items-center flex-nowrap gap-2"><input onclick="Calculate()"
                                                                name="permanent_address_mentioned" id="mn_padrs" value="2"
                                                                type="checkbox" />
                                                                <label class="mt-0 text-uppercase"
                                                                for="mn_padrs">Permanent address of the applicant mentioned in the application form?</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;">
                                                <select onchange="Calculate()" name="distance" id="cus_distance" class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;">
                                                <select onchange="Calculate()" name="gaurantors" id="gurantors" class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left !important;">
                                                <select onchange="Calculate()" name="educational_qualification" id="edu_qualify" class="form-control">
                                ...
                                <div class="form-basic pt-3">
                                    <div id="capable_action" class="mb-3" style="display: none">Sorry, your credit score is too low. Only authorized individuals can process this offer</div>
                                    <div id="capable_action_msg" class="mb-3" style="display: none">  Congratulations! You are eligible for our exclusive Buy It Pay Later offer.</div>
                                    <div class="align-items-center flex-nowrap gap-2" id="approve_cust_id" style="display: none">
                                        <input
                                            name="is_approved_id" id="approve_cust" onclick="approveBySalesman()"
                                            type="checkbox" />
                                            <label class="my-0 text-uppercase"
                                            for="approve_cust"> <span id="sales_man_name"></span> have approved this consumer to receive the Buy It Pay Later offer</label>
                                    </div>
                                    ...
                                    <button type="submit" id="sumit_btn"
                                        class="btn btn-lg btn-primary customr-btn btn-submit ms-auto">Save And Continue</button>
                                </div>
                            {{-- </form> --}}
                        </div>
                    </div>
...
function ReceivedSalesman(){
    ...
    function Calculate(){
        ...
        var total_score = parseInt(age) + parseInt(customer_status_score) + parseInt(monthly_income_score) + parseInt(profession_score) + parseInt(prof_length_score) + parseInt(family_size_score) + parseInt(res_status_score) + parseInt(cus_distance_score) + parseInt(gurantors_score) + parseInt(edu_qualify_score) + permanent_address_mentioned_score;
...
'display':'block'
    ...
    $(document).ready(function() {
        ...
        $('input[name="blacklist"], input[name="bad_creditor"], input[name="is_nid"]').click(function() {
            ...
            $('input[name="blacklist"], input[name="bad_creditor"], input[name="is_nid"]').each(function() {
                if ($(this).is(':checked') && $(this).val() === '1') {
