...
@section('content')
                        ...
                        <div class="card-body p-3" dir="ltr">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                      <select name="product_group_ids[]" id="product_group" class="form-control ih-medium ip-gray radius-xs b-light product_group" multiple="multiple">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" name="from_date" autocomplete="off" value="{{ request()->from_date ?? date('01-m-Y', strtotime('first day of next month')) }}" class="form-control ih-medium ip-gray radius-xs b-light" id="datepicker8">
                                    </div>
                                    <div style="width: 2%; height:40px;" class="col-1 d-flex justify-content-center align-items-center"><p class="m-0">To</p></div>
                                    <div class="col-md-2 mb-3">
                                        <input type="text" value="{{ request()->to_date ?? date('t-m-Y', strtotime('last day of next month')) }}" name="to_date" autocomplete="off" class="form-control ih-medium ip-gray radius-xs b-light" id="datepicker17">
                                    </div>
    ...
    function getData(page, event)
    {
        ...
        var custome = "{{ url('due-on-next-month-export?page=') }}"+page +"&"+paramStrings.join('&');
