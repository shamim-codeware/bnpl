...
@section('content')
                ...
                <div class="col-lg-12 mb-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h2>Defaulter Customers Report</h2>
    ...
    <script>
        ...
        function getData(page, event) {
            ...
            // Field validation - removed as date fields are commented out
            ...
            var custome = "{{ url('defaulter-report-export?page=') }}" + page + "&" + paramStrings.join('&');
            const anchor = $(
            ...
            // Call
            $.ajax({
                    url: "{{ url('defaulter-report-action?page=') }}" + page + "&" + paramStrings.join('&'),
                    type: "get",
                    datatype: "html",
                })
                .done(function(data) {
