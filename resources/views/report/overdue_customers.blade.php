...
@section('content')
                ...
                <div class="col-lg-12 mb-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h2>Overdue Customers Report</h2>
    ...
    <script>
        ...
        function getData(page, event) {
            ...
            var custome = "{{ url('overdue-report-export?page=') }}" + page + "&" + paramStrings.join('&');
            const anchor = $(
            ...
            // Call
            $.ajax({
                    url: "{{ url('overdue-report-action?page=') }}" + page + "&" + paramStrings.join('&'),
                    type: "get",
                    datatype: "html",
                })
                .done(function(data) {
