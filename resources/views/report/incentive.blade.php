...
@section('content')
                        ...
                        <div class="card-body p-3" dir="ltr">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-25">
                                        <select name="incentive_type" id="incentive_type" class="form-control">
                                            <option value="">All Incentive Type</option>
                                            <option value="down_payment">Down Payment</option>
                                            <option value="collection">Collection</option>
                                            <option value="sure_shot">Sure Shot</option>
                                        </select>
                                    </div>
    ...
    <script>
        ...
        function getData(page, event) {
            ...
            var custome = "{{ url('incentive-report-export?page=') }}" + page + "&" + paramStrings.join('&');
            const anchor = $(
            ...
            $.ajax({
                    url: "{{ url('incentive-report-action?page=') }}" + page + "&" + paramStrings.join('&'),
                    type: "get",
                    datatype: "html",
                })
                .done(function(data) {
