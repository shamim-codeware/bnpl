    ...
    <script>
        ...
        function getData(page, event) {
            var params = {
                ...
                from_date: $('#datepicker8').val(),
                to_date: $('#datepicker17').val(),
            ...
            var custome = "{{ url('all-bnpl-sales-export?page=') }}" + page + "&" + paramStrings.join('&');
            const anchor = $(
            ...
            // Call
            $.ajax({
                    url: "{{ url('all-bnpl-sales-action?page=') }}" + page + "&" + paramStrings.join('&'),
                    type: "get",
                    datatype: "html",
                })
                .done(function(data) {
