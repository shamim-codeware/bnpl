...
<body>
    <div class="formBody">
        ...
        <table style="margin-top:15px;">
            <tr>
                <td style="text-align:left; font-weight:bold; font-size: 15px;">
                    বিষয়: চেক জমাকরণ প্রসঙ্গে - চূড়ান্ত নোটিশ
                </td>
            </tr>
        </table>
        ...
        <p style="margin-bottom: 15px;">
            কোম্পানির সাথে বিক্রয় চুক্তির সিডিউল অনুসারে
        ...
        <p style="margin-bottom: 15px;">
            এমতাবস্থায় আপনি যদি <strong>{{ \Carbon\Carbon::parse($penalty->installment->loan_start_date)->addDays(92)->format('d M Y') }}</strong> তারিখের মধ্যে
            কিস্তির হিসাবে উল্লেখিত সমুদয় বকেয়া টাকা পরিশোধে ব্যর্থ হন,
            তাহলে কোম্পানি নিকট জমাকৃত চেক
            ব্যাংকে নগদিকরণের জন্য জমা দিতে বাধ্য হবে।
            তাই আপনার ব্যাংক হিসাবে পর্যাপ্ত পরিমাণ টাকা থাকা আবশ্যক।
            কোনো কারণে যদি আপনার ব্যাংক হিসাবে পর্যাপ্ত পরিমাণ টাকা না থাকে
            এবং চেকটি ডিজঅনার হয়, তাহলে বাংলাদেশে প্রচলিত আইনে
            আপনার বিরুদ্ধে আইনানুগ ব্যবস্থা গ্রহণ করা হবে।
        </p>

        <p>
            এই চিঠিটি চূড়ান্ত নোটিশ
            বলে গণ্য হবে।
        </p>
