...
<head>
    <meta charset="utf-8">
    <title>Guarantor Final Notice</title>
...
<body>
    <div class="formBody">
        ...
        <table style="margin-top:15px;">
            <tr>
                <td style="text-align:left; font-weight:bold; font-size: 15px;">
                    বিষয়: বকেয়া কিস্তি পরিশোধের অনুরোধ - গ্যারান্টর চূড়ান্ত নোটিশ
                </td>
            </tr>
        </table>
        ...
        <p style="margin-bottom: 14px;">
            ...
            <strong>(Ref: REL/BNPL/RLBNPLR00686-01, REL/BNPL/RLBNPLR00686-02)</strong>
            এবং মৌখিকভাবে একাধিকবার যোগাযোগ করা হয়েছে।
        ...
        <p style="margin-bottom: 14px;">
            ...
            গ্যারান্টর হিসেবে কিস্তি চুক্তি মতে সমুদয় বকেয়া মূল্য/কিস্তি প্রদানে
            সম্মত হয়েছেন।
        </p>
        ...
        <p style="margin-bottom: 14px;">
            ...
            <strong>অন্যথায়, আপনি এবং ক্রেতা উভয়ের চুক্তি ভঙ্গের অপরাধে অভিযুক্ত</strong>
            হবেন।
            আপনি এই বিষয়ে আলোচনা করতে চাইলে,
            কোম্পানির সাথে যোগাযোগ করতে অনুরোধ করা হলো।
        </p>

        <p>
            গ্যারান্টর হিসেবে আপনাকে এই বিষয়টি অবহিত করা হলো
        ...
        <table style="margin-top:27px;">
            <tr>
                ...
                <td
                    style="text-align: center; padding-top:5px; border-top:1.5px dashed #000; vertical-align:bottom; padding-bottom: 15px;">
