...
<div class="formBody" style="width: 795px;margin:0 auto;">
    <table style="width:100%;" cellspacing="0">
        <tbody>
            <tr>
                <table style="width:100%;margin-bottom:0px" cellspacing="0">
                    <tr>
                        <td>
                            <h2
                                style="font-weight: 700; font-size: 24px; color: #000;margin-top:0; margin-bottom: 3px;">
                                র‍্যাংগ্স ইলেকট্রনিক্স লিমিটেড
                            </h2>
                            <p
                                style="font-size: 12.5px; line-height: 14px; margin: 0;margin-bottom: 2px;font-weight:500;">
                                সোনারতরী টাওয়ার, ১২ সোনারগাঁও রোড, ঢাকা-১০০০, বাংলাদেশ।
                            </p>
                            <p style="font-size: 12.5px; line-height: 14px; margin: 0;font-weight:500;">
                                হটলাইন : +৮৮ ০৯৬৭৭ ২৪৪ ২৪৪, ই-মেইল : <span
                                    style="font-family: 'Jost', sans-serif;">marketing@rangs.com.bd</span>
                            </p>
                        </td>
                    ...
                    <tr>
                        <td style="width: 42%;">
                            <table style="width:100%;font-size:14px; text-align:left;">
                                <tr>
                                    <td colspan="2"
                                        style="background:#e30613; color:#fff; font-weight:600; text-align:center; padding:3px !important; font-size:14px !important;font-family: 'Jost', sans-serif;">
                                        OFFICE USE ONLY
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td
                                        style="border:1px solid #000; padding:6px; background: #F2F2F2; font-weight:500;font-family: 'Jost', sans-serif;font-size:12px;padding:1px !important;">
                                        BNPL Order No.</td>
                                    <td
                                        style="border:1px solid #000; padding:6px; background: #F2F2F2;font-family: 'Jost', sans-serif;font-size:12px;padding: 1px !important;">
                                        {{ @$hirePurchase->order_no }}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="border:1px solid #000; padding:6px; background: #F2F2F2;font-family: 'Jost', sans-serif;font-size:12px;padding: 1px !important;">
                                        {{ @$hirePurchase->monthly_installment }}</td>
                                </tr>

                                <tr>
                                    <td
                                        style="border:1px solid #000; padding:6px; background: #F2F2F2; font-weight:500;font-family: 'Jost', sans-serif;font-size:12px;padding: 1px !important;">
                                        Total Installment</td>
                                    <td
                                        style="border:1px solid #000; padding:6px; background: #F2F2F2;font-family: 'Jost', sans-serif;font-size:12px;padding: 1px !important;">
                        ...
                        <td style="text-align:center;vertical-align:middle;">
                            <!-- Center Badge -->
                            <div
                                style="background-color: #ec2026; color: white; padding: 5px 22px; border-radius: 16px; display: inline-block; font-weight: 600; font-size: 18px; text-align: center;">
                        ...
                        <td>
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    <td
                                        style="font-size:12px !important;border:1.5px solid #000;vertical-align:middle;width:119px;height:200px;text-align:center;padding:15px !important;">
            ...
            <tr>
                <table style="width:100%;" cellspacing="0">
                        ...
                        <td style="padding-top:10px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;">
                                        {{ $hirePurchase->name }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;">
                                        {{ $hirePurchase->fathers_name }}</td>
                                    <td style="width: 17%;font-weight:600;padding-left:5px !important;">৩)ন্যাশনাল আইডি
                                        নং:</td>
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;">
                                        {{ $hirePurchase->nid }}
                    ...
                    <tr>
                        <td style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    <td style="width:28%;">
                                        <strong style="font-weight:600;">৪)বর্তমান বাসস্থানের ঠিকানা:</strong>
                                        বাড়ি/গ্রাম:
                                    </td>
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;">
                        ...
                        <td style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 10%;">
                                        {{ $hirePurchase->pr_duration_staying }}</td>
                                    <td style="padding-left: 5px !important;width: 4%;">বছর</td>
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 10%;">
                                    </td>
                                    <td style="font-weight:600;padding-left:5px !important;">মাস ধরে এই ঠিকানায় বসবাস
                                        করছি।</td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width:46%">
                        ...
                        <td style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width:20%;">
                                        {{ $hirePurchase->customer_profession->name }}
                                    </td>
                                    <td style="width: 6%;font-weight:600;padding-left: 5px !important;">পদবী:</td>
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;">
                                        {{ $hirePurchase->designation }}</td>
                                    <td style="width: 26%;padding-left:5px !important">কতদিন ধরে বর্তমান পেশার সাথে
                                        যুক্ত:</td>
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 5%;">
                            ...
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="font-weight:600;">৯)
                                        <input type="checkbox"
                                            @if ($hirePurchase->marital_status == 'married') @checked(true) @endif
                                            name="marital_status" id="married"> <label
                                            for="married">বিবাহিত/</label>
                                        <input type="checkbox"
                                            @if ($hirePurchase->marital_status == 'Unmarried') @checked(true) @endif
                                            name="marital_status" id="unmarried"> <label
                                ...
                                <td style="padding-top: 7px;">
                                    <table style="width:100%;" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 40%;">{{ $row->name }}
                                            </td>
                                            <td>সম্পর্ক</td>
                                            <td style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 30%;">
                                                {{ $row->relation }}</td>
                                            <td>বয়স</td>
                                            <td style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 15%;">{{ $row->age }}
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <td style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 4%;">
                                    </td>
                        ...
                        <td style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 45%;">
                                        {{ @$hirePurchase->purchase_products->pluck('product.product_model')->implode(', ') }}
                                    </td>
                            ...
                            <td style="padding-top: 7px;">
                                <table style="width:100%;" cellspacing="0">
                                    <tr>
                                        ...
                                        <td
                                            style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 40%;">
                                            {{ $hirePurchase->pre_b_product_id == 'others'
                                                ? $hirePurchase->type_product
                                                : optional($hirePurchase->pre_purchase_product)->product_model }}
                                        </td>
                                        <td style="width: 11%;">
                                            ক্রয়ের তারিখ:
                                        </td>
                                        <td
                                            style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;">
                                            {{ $hirePurchase->pre_purchase_date }}
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <td style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 29%;">
                                        {{ @$hirePurchase->show_room->name }}
                                    </td>
                                    <td style="width: 11%;padding-left: 5px !important;">
                                        শোরুমের দূরত্ব:
                                    </td>
                                    <td
                                        style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 7%;">
                    ...
                    <tr>
                        <td style="padding-top: 7px;font-weight:600;">(১৫) আপনার আত্মীয়/পরিচিত এমন দুজন ব্যক্তি যারা
                            আপনার গ্যারান্টর
                            অথবা
                            ...
                            <td style="padding-top: 7px;">
                                <table style="width:100%;" cellspacing="0">
                                    <tr>
                                        ...
                                        <td
                                            style="border: 1px solid #000;background: #F2F2F2;padding-left:3px !important;font-family: 'Jost', sans-serif;;width: 32%;">
    ...
    <p style="margin-bottom: 0; margin-top:2px">
        আমি/আমরা (১) ও (২) নং অংশে উল্লেখিত ব্যক্তি/ব্যক্তিবর্গ এই আবেদন পত্রের ২য় ও ৩য় পৃষ্ঠায় বর্ণিত ও প্রদত্ত সকল
        তথ্য অবগত হইয়া স্বেচ্ছায় ও সজ্ঞানে হইতে সম্মত হইলাম এবং সেই সাথে এই মর্মে অঙ্গীকার করিতেছি যে, আবেদনকারী
        কিস্তিতে যে পণ্যটি ক্রয়ের জন্য আবেদন করিয়াছেন, তাহার নিকট ঐ পণ্যটি কিস্তিতে বিক্রয় করা হলে যদি সে ঐ পণ্যটির
        মূল্য মাসিক কিস্তিতে নিয়মিত ভাবে এবং যথাসময়ে পরিশোধ করিতে ব্যর্থ হয় সেক্ষেত্রে আমি/আমরা উহার অপরিশোধিত মূল্য
        পরিশোধে করিতে অথবা পণ্যটি ফেরত দেওয়ার ব্যবস্থা করিতে আইনত বাধ্য থাকিব।
    </p>
    <p style="margin-top: 5px;margin-bottom:0;">এই চুক্তিনামা আজ, <span
            style="font-family: 'Jost', Arial, sans-serif; font-size: 12px;">{{ date('d/m/Y h:i A', strtotime($hirePurchase->updated_at)) }}</span>
        তারিখ উপরোক্ত পক্ষসমূহের মধ্যে নিম্নলিখিত শর্তাবলীর
        সম্মতি সাপেক্ষে,সম্পাদিত হল।</p>

    <table style="width:100%;" cellspacing="0">
        <tr>
            <td style="padding-top: 15px !important;padding-bottom:0 !important;">
                <p style="border-top: 2px dotted #000;padding-top: 4px; text-align: center;margin:0;">১ম নিশ্চয়তা
                    প্রদানকারীর স্বাক্ষর</p>
            </td>
            <td style="width: 15%;padding-bottom:0 !important;"></td>
            <td style="padding-top: 15px !important;padding-bottom:0 !important;">
    ...
    <p
        style="background: #000;color: #fff;margin: 0 auto;padding: 5px;text-align: center;width: 90px;font-size:18px;margin-bottom: 0;">
        শর্তাবলী: </p>
    @php
    ...
    @endphp
    <p>১ । কিস্তিতে পণ্য গ্রহণকারী কর্তৃক ১ম কিস্তি <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">
            {{ @$hirePurchase->down_payment }} </span> টাকা এবং
        অবশিষ্ট <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">{{ @$hirePurchase->hire_price - @$hirePurchase->down_payment }}
        </span> টাকা ভবিষ্যতে <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">{{ @$hirePurchase->installment_month - 1 }}</span>
        টি কিস্তিতে
        মাসিক <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">{{ @$hirePurchase->monthly_installment }}</span>
        টাকা হারে প্রদানের অঙ্গীকারের ভিত্তিতে ও প্রতিনিধিগণের অনুরোধে র‌্যাংগ্স ইলেকট্রনিকস
        লিমিটেড কিস্তিতে পণ্য গ্রহণকারীকে <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">{{ @$hirePurchase->purchase_products->pluck('product_category.name')->implode(', ') }}</span>
        মডেল <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">
            {{ @$hirePurchase->purchase_products->pluck('product.product_model')->implode(', ') }}</span> সিরিয়াল
        নম্বর <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">
            {{ @$hirePurchase->purchase_products->pluck('serial_no')->implode(', ') }}</span> (অতঃপর কিস্তিকৃত পণ্য
        হিসেবে গণ্য হবে) যার
        সর্বমোট মূল্য <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">{{ @$hirePurchase->hire_price }}</span>
        টাকা
        কথায় <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">{{ $hirePriceInWords }}</span>
        প্রদান করতে (কিস্তিতে পণ্য গ্রহণকারী ক্রয় করার অধিকার সাপেক্ষে) সম্মত হলেন।</p>


    <p><span style="display: block;font-weight:600;">২। কিস্তি চলাকালীন সময়ে কিস্তি গ্রহণকারী নিম্নবর্ণিত শর্তসমূহ মেনে
            চলতে বাধ্য থাকবেন।</span>

        (ক) কিস্তি গ্রহণকারী মাসিক কিস্তি <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">{{ @$hirePurchase->monthly_installment }}</span>
        টাকা, প্রতি মাসের <span
            style="border: 1px solid #000;background: #F2F2F2;padding: 1px 3px;margin-bottom: 1px;display: inline-block;font-family: 'Jost', sans-serif;">{{ date('d', strtotime($hirePurchase->created_at)) }}</span>
        তারিখ এর
    ...
    <p>(ঘ) কিস্তিকৃত পণ্য, কিস্তি গ্রহণকারী উপরোল্লিখিত ঠিকানায় নিজ দায়িত্বে ও তত্ত্বাবধায়নে রাখবেন এবং র‌্যাংগ্স
        ...
        কিস্তি গ্রহণকারী ভঙ্গ করলে বা তাদের যে কেউ অনুরূপ করিলে র‌্যাংগ্স ইলেকট্রনিকস লিমিটেড এর চুক্তি বাতিল করার
    ...
    <p>
        ...
        বা কোন সময়ের জন্য যদি অন্য কারো দখল হতে কিস্তিকৃত পণ্য পুনরূদ্ধার করতে হয়, তাহার যাবতীয় খরচাদি চাহিবা মাত্র
    ...
    <p>৬। কিস্তি গ্রহণকারী এই চুক্তিকালীন সময়ে কিস্তির শর্তাবলি যথাযথভাবে পালন পূর্বক কিস্তিকৃত পণ্য ক্রয়ের অধিকারী হবেন
        তবে এই ক্ষেত্রে র‌্যাংগ্স ইলেকট্রনিকস লিমিটেড এর প্রচলিত নিয়ম অনুযায়ী শীঘ্রই অর্থ পরিশোধের জন্য তাহাকে রেয়াত
        দেওয়া যাবে।</p>
    ...
    <p>(ঘ) এমন কোন কাজ করে যা কিস্তিকৃত পণ্যের উপর র‌্যাংগ্স ইলেকট্রনিকস লিমিটেড এর স্বার্থ ও অধিকার ক্ষুন্ন হয় ।
        ...
        কিস্তি গ্রহণকারী এই চুক্তিতে বর্ণিত তাহার উপর অর্পিত সকল বা যে কোন শর্ত ও বিধানাবলি যথাযথ ভাবে পালন ও সম্পন্ন
        করতে ব্যর্থ হলে র‌্যাংগ্স ইলেকট্রনিকস লিমিটেড তৎক্ষণাৎ কিস্তির চুক্তি বাতিল (ইহার অন্য
        যেকোন অধিকার ক্ষুন্ন না করে) করার অধিকারী হবেন এবং অত্র চুক্তি বলে কিস্তিকৃত পণ্য পূর্ণদখল নিতে পারবেন।</p>


    <p>৮। উপরোল্লিখিত অনুচ্ছেদের অধীনে কিস্তির চুক্তি বাতিল হলে কিত্তি গ্রহণকারী বা তার আইন সম্মত উত্তরাধিকারী তৎক্ষণাৎ
        কিস্তিকৃত পণ্য নিজ খরচে
        র‌্যাংগস ইলেকট্রনিকস লিমিটেড এর যে শো-রুম হতে পণ্য কিস্তি গ্রহণ করা হয়েছে সেখানে বা র‌্যাংগস ইলেকট্রনিকস লিমিটেড
        এর অফিসে হস্তান্তর
        করবেন। </p>

    <p>
        ৯। কিস্তি গ্রহণকারী তা করতে ব্যর্থ হলে র‌্যাংগস ইলেকট্রনিকস লিমিটেড বা এর প্রতিনিধি ব্য কর্মচারী বা র‌্যাংগস
        ইলেকট্রনিকস লিমিটেড এর মনোনীত
        যেকোন ব্যক্তি যেকোন স্থানে যেখানে রক্ষিত আছে বলে প্রতীয়মান হবে, সেখানে প্রবেশ করে মালামালের দখল নিতে পারবেন।
        সেক্ষেত্রে কিস্তি
        গ্রহণকারী বা তার মনোনীত কোন ব্যক্তি অন্য কোন ভাবে র‌্যাংগস ইলেকট্রনিকস লিমিটেড এর বিরুদ্ধে কোন প্রকার মামলা
        দায়ের বা কার্যক্রম গ্রহণ
        করতে পারবেন না।
    </p>

    <p>
        ১০। কিস্তি গ্রাহক, মাসিক কিস্তি প্রদেয় হবার তারিখের পরের মাসের মধ্যেও যদি কিস্তির টাকা পরিশোধে ব্যর্থ হন,
        সেক্ষেত্রে ২য় মাস থেকে প্রতি বকেয়া
        মাসের জন্য, ৫০০/- টাকা করে কিস্তিমূল্যের সাথে জরিমানা যোগ হবে।
    </p>

    <p>
        ১১। এই চুক্তিনামার যেকোন বিধানের অধীনে কিস্তির চুক্তি বাতিল হলে, তৎক্ষণাৎ সকল বকেয়া কিস্তি র‌্যাংগ্স ইলেকট্রনিকস
        লিমিটেড এর পণ্য গ্রহণের
        তারিখ পর্যন্ত এই চুক্তিনামা যে কোন বিধান অনুযায়ী ধার্য খরচাদি, দায়, পণ্য দখল নেওয়া, স্থানান্তর করার খরচাদি, পণ্য
        ভাল ও যথাযথ অবস্থায় আনার
        জন্য আনুষাঙ্গিক খরচাদিসহ যাবতীয় অর্থ র‌্যাংগস ইলেকট্রনিকস লিমিটেড এর কাছে পরিশোধ করবেন (যথাযথ ব্যবহার জনিত ক্ষয়
        ব্যতিরেকে) এই
        চুক্তিনামার বিধান অনুযায়ী ইতিপূর্বে পরিশোধিত অর্থ কোন অবস্থাতে র‌্যাংগস ইলেকট্রনিকস লিমিটেড কিস্তি গ্রহণকারীকে
        ফেরত প্রদান করবেন না।
    </p>

    <p>১২। এই চুক্তিনামা কিস্তি গ্রহণকারীর নিজস্ব ও ব্যক্তিগত ব্যাপার এবং কিস্তি গ্রহণকারী এই চুক্তির বলে প্রাপ্ত তাঁর
        অধিকার এবং দায়-দায়িত্ব প্রত্যক্ষ বা
        পরোক্ষভাবে অন্য কাউকে হস্তান্তর বা অর্পণ করতে পারবেন না।</p>

    <p>
        ১৩। প্রতিনিধিগণ সম্মিলিতভাবে বা পৃথক পৃথকভাবে সম্মত হলেন যে তাহাদের দায়দায়িত্ব কিস্তি গ্রহণকারীর অনুরূপ হবে।
        যদিও সকল ক্ষেত্রে তাহাদের
    ...
    <p>
        (খ) এই চুক্তির অধীনে বা বলে সকল প্রকার অর্থ যা ঋণ হোক আর কিস্তিই হোক বা ক্ষতিপূরণ, খরচাদি, যাই হোক না কেন, সমুদয়
        অর্থ র‌্যাংগস
    ...
    <p>
        ...
        করার বিশেষ অধিকার র‌্যাংগ্স
        ইলেকট্রনিকস লিমিটেড এর থাকবে।
    </p>
    <p>
        (খ) প্রতিনিধিগণ কিস্তি গ্রহণকারীর কিস্তিকৃত পণ্যের উপর দাবীদার হওয়ার অধিকার এতদ্বারা পরিত্যাগ করেন এবং সেই সাথে
        আইনানুগ যে সুবিধা
        পাওয়ার যোগ্য তাও এতদ্বারা পরিত্যাগ করেন।
    </p>
    <p>
        (গ) এই চুক্তি নামার আওতায় কিস্তি গ্রহণকারীর নিকট হতে কোন পাওনা অর্থ আদায় করতে র‌্যাংগ্স ইলেকট্রনিকস লিমিটেড বা
        এর মনোনীত
        প্রতিনিধির কোন অবহেলা বা সহিষ্ণুতা বা অন্য যে কোনোভাবে উদাসীনতা থাকলে কিস্তি গ্রহণকারী বা প্রতিনিধিগণ অত্র
        চুক্তিনামার অধীনে দায়িত্ব
        ও কর্তৃব্য হতে মুক্ত হবেন না বা অন্য কোনভাবে কিস্তি গ্রহণকারী বা প্রতিনিধিগণের উল্লেখিত দায়িত্ব ও কর্তব্য
        পরিবর্তিত হবেনা এবং অন্য
        কোনভাবে র‌্যাংগস ইলেকট্রনিকস লিমিটেড এর অধিকারসমূহ ক্ষুন্ন হবে না।
    </p>
    <p>
        ১৫। কোন নোটিশ রেজিষ্টার্ড ডাকযোগে র‌্যাংগস ইলেকট্রনিকস লিমিটেড এর বেলায় ইহার উপরের বর্ণিত ঢাকাস্থ অফিসে পাঠালে
        এবং কিস্তি গ্রহণকারী বা
        যেকোন প্রতিনিধির বেলায় তাহাদের উপরে বর্ণিত ঠিকানায় পাঠালে তা যথাযথভাবে প্রদান করা হয়েছে বলে বিবেচিত হবে। কিস্তি
        গ্রহণকারী ও
        প্রতিনিধিগণের উপর বর্ণিত নিজ নিজ ঠিকানায় বা কোন পরিবর্তিত ঠিকানায় যদি উহ্য র‌্যাংগ্স ইলেকট্রনিকস লিমিটেড কে
        জ্ঞাত করা হয়ে থাকে তাহলে
        এই ধরনের নোটিশ প্রাপ্তির পরের দিনেই যথাযথভাবে জারি ও কার্যকারী হয়েছে বলে বিবেচিত হবে।
    </p>


    <p>এতদ্বার্থে স্বেচ্ছায়, স্বজ্ঞানে, সুস্থ মস্তিষ্কে, অন্যের বিনা প্ররোচনায় অত্র চুক্তিনামা দলিল নিজে পড়ে বা অন্যের
        দ্বারা পড়িয়ে ইহার মর্ম সমাক্ষ অবগত হয়ে
        স্বাক্ষীগণের মোকাবেলায় পক্ষগণ এবং প্রতিনিধিগণ নিজ নিজ নাম সহি স্বাক্ষর করলাম</p>

    <p>র‌্যাংগস ইলেকট্রনিক্স লিঃ কোন কারণ দর্শানো ব্যাতিরেকে উপরে উলেখিত শর্তাবলী পরিবর্তন, পরিবর্ধন ও সংশোধন করার
        অধিকার সংরক্ষণ করে এবং
    ...
    <table style="width: 100%;padding-top:20px;" cellspacing="0">
        <tr>
            <td style="padding-right: 15px !important;">
                ...
                <p>২. আবেদনকারীর জাতীয় পরিচয়পত্রের কপির স্বাক্ষর সহ ফটোকপি।</p>
                <p>৩. আবেদনকারীর বর্তমান ঠিকানার ইউটিলিটি (বিদ্যুৎ, পানি বা গ্যাস ইত্যাদি) বিলের কপি - স্বাক্ষরসহ
                    ফটোকপি।</p>
                <p>৪. আবেদনকারীর ব্যাংক একাউন্টের স্বাক্ষরসহ এবং তারিখ বিহীন একটি চেক - মূল কপি। </p>
                <p>৫. আবেদনকারীর বর্তমান পেশার স্বপক্ষের প্রমাণাদি (আইডি কার্ড, ভিজিটিং কার্ড, বাড়ি মালিকের ক্ষেত্রে
                    বাড়ি ভাড়া গ্রহণের রশিদের কপি ইত্যাদি)।</p>
                <p>৬. ১ম নিশ্চয়তা প্রদানকারীর জাতীয় পরিচয়পত্রের কপি - স্বাক্ষর সহ ফটোকপি।</p>
                <p>৭. ১ম নিশ্চয়তা প্রদানকারীর প্রদত্ত ঠিকানার ইউটিলিটি (বিদ্যুৎ, পানি বা গ্যাস ইত্যাদি) বিলের কপি -
                    স্বাক্ষরসহ ফটোকপি।</p>
                <p>৮. ২য় নিশ্চয়তা প্রদানকারীর জাতীয় পরিচয়পত্রের কপি। স্বাক্ষর সহ ফটোকপি।</p>
                <p>৯. ২য় নিশ্চয়তা প্রদানকারীর প্রদত্ত ঠিকানার ইউটিলিটি (বিদ্যুৎ, পানি বা গ্যাস ইত্যাদি) বিলের কপি
                    স্বাক্ষরসহ ফটোকপি। </p>
            ...
            <td style="width:38%;vertical-align: top;">
                <table style="width:100%;padding-top: 34px;height:100%;" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2"
                            style="text-align: center;padding-top: 7px; vertical-align:middle;height:180px;">
                    ...
                    <tr>
                        <td colspan="2"
                            style="text-align: center;padding-top:5px !important;border-top:2px dotted #000;vertical-align:bottom;padding-bottom: 45px !important;text-align: center;font-weight:600;">
                            বিক্রয় প্রতিনিধির সীলসহ স্বাক্ষর
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"
                            style="text-align: center;padding-top:5px !important;border-top:2px dotted #000;vertical-align:bottom;text-align: center;font-weight:600;">
