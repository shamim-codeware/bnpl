        ...
        <tbody> 
            <tr>
                <table style="width:100%;margin-bottom:5px" cellspacing="0">
                    <tr>
                        <td>
                            <h2 style="font-weight: 700; font-size: 20px; color: #000;margin-top:0; margin-bottom: 0;">
            ...
            <tr>
                ...
                <table style="width:100%;" cellspacing="0" class= @if($key==1) second_guarantor @else first_guarantor @endif>
                    <tr>
                        ...
                        @endif
                        <td @if($key==1) rowspan="5" @else rowspan="3" @endif style="font-size:11px !important;border:1px solid #000;vertical-align:middle;width:100px;height:110px;text-align:center">
                    ...
                    <tr>
                        <td style="padding-top:10px;width:79%;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    <td style="width:51%;background:#000;color:#fff;">১)@if($key==1) ২য়@else ১ম@endif প্রস্তাবিত নিশ্চয়তা প্রদানকারীর নাম- মিঃ/মিসেস/মিস:</td>
                                    <td style="width:1.5px;"></td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->guarater_name }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->guarater_relation_name}}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td @if($key==0) colspan="2" @endif style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->guarater_address_present }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td @if($key==0) colspan="2" @endif style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->guarater_nid }}</td>
                                    <td style= @if($key==1) width:14% @else width:11% @endif>গ. মোবাইল নং:</td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->guarater_phone }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td colspan="2" style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important;width: 3%;">{{ $guaran->duration_of_staying }}</td>
                                    <td style="width: 1%;padding-left:5px !important;">বছর</td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important;width: 3%;"></td>
                                     <td style="width: 3%;padding-left:5px !important;">মাস</td>
                                    <td style="width: 8%;">
                                       ঙ. নিজস্ব বাড়ি/ভাড়া :
                                    </td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important;width:17%;">{{ $guaran->residense_status }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td colspan="2" style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->guarater_address_permanent }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td colspan="2" style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->age }}</td>
                                    <td style="width: 4%;">বছর,</td>
                                    <td style="width: 13%;">খ.বৈবাহিক অবস্থা</td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->marital_status }}</td>
                                    
                                    <td style="width: 12%;">গ.সন্তানের সংখ্যা</td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->number_of_children }}</td>
                                    <td style="width: 19%;">ঘ.অন্যান্য পোষ্যদের সংখ্যা:</td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->other_family_member }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td colspan="2" style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important;width: 24%;">{{ @$guaran->profession->name}}</td>
                                    <td style="padding-left: 5px !important">খ.পদবী</td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important;width: 30%;">{{ $guaran->designation }}</td>
                        ...
                        <td colspan="2" style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->monthly_income }}</td>
                                    <td style="padding-left:5px !important;width:7%;">টাকা</td>
                                    <td style="width: 25%;">ঙ. কতদিন বর্তমান পেশার সাথে যুক্ত:</td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->duration_current_profession }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td colspan="2" style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->name_address_office }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td colspan="2" style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ @$HirePurchaseProduct->brand->name }}</td>
                                    <td style="width: 13%;">ব্র্যান্ডের,মডেল নং:</td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ @$HirePurchaseProduct->product->product_model }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td colspan="2" style="padding-top: 7px;">
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important;width: 20%;">{{ @$HirePurchaseProduct->hire_price }}</td>
                                    <td>কিস্তিতে কেনার জন্য</td>
                                    <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important;width: 44%;">{{ @$HirePurchase }}</td>
                                    <td>
                            ...
                            <table style="width:100%;" cellspacing="0">
                                <tr>
                                    <td style="padding-right: 10px;">
                                        <table style="width:100%;" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="border: 1px solid #000;background: #e6e7e9;padding-left:3px !important">{{ $guaran->relation }}</td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td style="border: 1px solid #000;padding: 0 !important;">
                                        ...
                                        <p style="border-top: 2px dotted #000;padding-top: 4px; text-align: center;margin-top:10px;margin-bottom:0;">@if($key==1) ২য়@else ১ম@endif নিশ্চয়তাপ্রদানকারীর স্বাক্ষর</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <td  style="padding-top: 7px;">
                    <table style="width:100%;" cellspacing="0">
                        <tr>
                            ...
                            <td style="width: 32%;!important;padding-top: 15px !important;">
