...
//         xaxis: { categories: ["Total", "Collected", "Outstanding"] },
//     };
//     $(e).length > 0 && new ApexCharts(document.querySelector(e), r).render();
// }
        ...
        i = {
            ...
            events: [
                ...
                },
                {
                    ...
                    title: "Hire Purchase Application - Rangs",
                },
            ],
            className: "warning",
            textColor: "#FA8B0C",
...
!(function (e) {
    ...
    p.classList.add("overlay-dark"),
        ...
        e("#cus_status").select2({
            placeholder: "CUSTOMER STATUS",
            dropdownCssClass: "cus_status",
            allowClear: !0,
        }),
        e("#monthly_income").select2({
            placeholder: "MONTHLY INCOME",
            dropdownCssClass: "monthly_income",
            allowClear: !0,
        }),
        e("#profession").select2({
            placeholder: "PROFESSION",
            dropdownCssClass: "profession",
            allowClear: !0,
        }),
        e("#prof_length").select2({
            placeholder: "LENGTH OF PROFESSION",
            dropdownCssClass: "prof_length",
            allowClear: !0,
        }),
        e("#family_size").select2({
            placeholder: "FAMILY SIZE(NUMBERS OF FAMILY MEMBERS)",
            dropdownCssClass: "family_size",
            allowClear: !0,
        }),
        e("#res_status").select2({
            placeholder: "RESIDENCE STATUS",
            dropdownCssClass: "res_status",
            allowClear: !0,
        }),
        e("#cus_distance").select2({
            placeholder: "DISTANCE OF CUSTOMER'S RESIDENCE FROM CTP/PRODUCT USE",
            dropdownCssClass: "cus_distance",
            allowClear: !0,
        }),
        e("#gurantors").select2({
            placeholder: "GUARANTORS",
            dropdownCssClass: "gurantors",
            allowClear: !0,
        }),
        e("#edu_qualify").select2({
            placeholder: "EDUCATIONAL QUALIFICATIONS",
            dropdownCssClass: "edu_qualify",
            allowClear: !0,
        }),
        e("#product_size_id").select2({
            placeholder: "Select Product Size ",
            dropdownCssClass: "product_size_id",
            allowClear: !0,
        }),
        e("#fhw_name").select2({
            placeholder: "Select",
            dropdownCssClass: "fhw_name",
            allowClear: !0,
        }),
        e("#showroom_user_id").select2({
            placeholder: "Sales Representative",
            dropdownCssClass: "ShowRoom User",
            allowClear: !0,
        }),
        e("#g_fhw_name").select2({
            placeholder: "Select",
            dropdownCssClass: "g_fhw_name",
            allowClear: !0,
        }),
        e("#g2_fhw_name").select2({
            placeholder: "Select",
            dropdownCssClass: "g2_fhw_name",
            allowClear: !0,
        }),
        e("#g_fhw_name2").select2({
            placeholder: "Select",
            dropdownCssClass: "g_fhw_name2",
            allowClear: !0,
        }),
        e("#marital_status").select2({
            placeholder: "Marital status",
            dropdownCssClass: "marital_status",
            allowClear: !0,
        }),
        e("#marital_status_0").select2({
            placeholder: "Marital status",
            dropdownCssClass: "marital_status_0",
            allowClear: !0,
        }),
        e("#marital_status_1").select2({
            placeholder: "Marital status",
            dropdownCssClass: "marital_status_1",
            allowClear: !0,
        }),
        e("#rs_district").select2({
            placeholder: "Select District",
            dropdownCssClass: "rs_distric",
            allowClear: !0,
        }),
        e("#rs_thana").select2({
            placeholder: "Select Thana",
            dropdownCssClass: "rs_thana",
            allowClear: !0,
        }),
        e("#prof_district").select2({
            placeholder: "Select District",
            dropdownCssClass: "prof_distric",
            allowClear: !0,
        }),
        e("#prof_thana").select2({
            placeholder: "Select Thana",
            dropdownCssClass: "prof_thana",
            allowClear: !0,
        }),
        e("#purchs_item").select2({
            placeholder: "Product Name",
            dropdownCssClass: "purchs_item",
            allowClear: !0,
        }),
        e("#product_bought").select2({
            placeholder: "Product Name",
            dropdownCssClass: "product_bought",
            allowClear: !0,
        }),
        e("#rs_status").select2({
            placeholder: "Residence Status",
            dropdownCssClass: "rs_status",
            allowClear: !0,
        }),
        e("#padrs_district").select2({
            placeholder: "Select District",
            dropdownCssClass: "padrs_distric",
            allowClear: !0,
        }),
        e("#padrs_thana").select2({
            placeholder: "Select Thana",
            dropdownCssClass: "padrs_thana",
            allowClear: !0,
        }),
        e("#relation").select2({
            placeholder: "Relation",
            dropdownCssClass: "relation",
            allowClear: !0,
        }),
        e("#prod_brand").select2({
            placeholder: "Product Brand",
            dropdownCssClass: "prod_brand",
            allowClear: !0,
        }),
        e("#prod_model").select2({
            placeholder: "Product Model",
            dropdownCssClass: "prod_model",
            allowClear: !0,
        }),
        e("#prod_cat").select2({
            placeholder: "Product Category",
            dropdownCssClass: "prod_cat",
            allowClear: !0,
        }),
        e("#brand_id").select2({
        ...
        e("#inst_month").select2({
            placeholder: "How many months are you accepting installments?",
            dropdownCssClass: "inst_month",
            allowClear: !0,
        }),
        e("#ctp").select2({
            placeholder: "Select CTP",
            dropdownCssClass: "ctp",
            allowClear: !0,
        }),
        e("#cust_relation").select2({
            placeholder: "Relation with Customer",
            dropdownCssClass: "ctp",
            allowClear: !0,
        }),
        e("#cust_relation_0").select2({
            placeholder: "Relation with Customer",
            dropdownCssClass: "cust_relation_0",
            allowClear: !0,
        }),
        e("#cust_relation_1").select2({
            placeholder: "Relation with Customer",
            dropdownCssClass: "cust_relation_1",
            allowClear: !0,
        }),
        e("#bank_name").select2({
        ...
        e("#store_type").select2({
            dropdownCssClass: "store_type",
            allowClear: !0,
        }),
        e("#zone").select2({
            placeholder: "Zone",
            dropdownCssClass: "zone",
            allowClear: !0,
        }),
        e("#all_zone").select2({
            placeholder: "All Zone",
            dropdownCssClass: "all_zone",
            allowClear: !0,
        }),
        e("#showroom_id").select2({
            placeholder: "Select Showroom",
            dropdownCssClass: "all_zone",
            allowClear: !0,
        }),
        e("#showroom_ctp").select2({
            placeholder: "Showroom/CTP",
            dropdownCssClass: "showroom_ctp",
            allowClear: !0,
        }),
        e("#report_type").select2({
            placeholder: "Report Type",
            dropdownCssClass: "report_type",
            allowClear: !0,
        }),
        e("#product_group").select2({
            dropdownCssClass: "product_group",
            allowClear: !0,
        }),
        e("#mother_spouse").select2({
            placeholder: "Select",
            dropdownCssClass: "mother_spouse",
            allowClear: !0,
        }),
        e("#mother_spouse2").select2({
            placeholder: "Select",
            dropdownCssClass: "mother_spouse2",
            allowClear: !0,
        }),
        e("#installment_month").select2({
            placeholder: "Installment Month",
            dropdownCssClass: "installment_month",
            allowClear: !0,
        }),
        e("#zone_type").select2({
            placeholder: "Zone Type",
            dropdownCssClass: "zone_type",
            allowClear: !0,
        }),
        e("#customer_status").select2({
            placeholder: "CUSTOMER STATUS",
            dropdownCssClass: "customer_status",
            allowClear: !0,
        }),
    ...
    q &&
        ...
        e("#delivery_showroom_id").select2({
            placeholder: "Select Delivery ShowRoom",
            dropdownCssClass: "tag",
            allowClear: !0,
        }),
        // e("#select-model").select2({
        ...
        e("#age_0").select2({
            placeholder: "AGE",
            dropdownCssClass: "age_0",
            allowClear: !0,
        }),
        e("#age_1").select2({
            placeholder: "AGE",
            dropdownCssClass: "age_1",
            allowClear: !0,
        }),
        ...
        e(".toggle-password3").click(function () {
            e(this).toggleClass("uil-eye"),
                (input = e(this).parent().find("#change_pass")),
                "password" == input.attr("type")
                    ? input.attr("type", "text")
                    : input.attr("type", "password");
        }),
        e(".toggle-password4").click(function () {
            e(this).toggleClass("uil-eye"),
                (input = e(this).parent().find("#n_pass")),
                "password" == input.attr("type")
                    ? input.attr("type", "text")
                    : input.attr("type", "password");
        }),
        e(".toggle-password5").click(function () {
            e(this).toggleClass("uil-eye"),
                (input = e(this).parent().find("#c_password")),
                "password" == input.attr("type")
                    ? input.attr("type", "text")
                    : input.attr("type", "password");
        }),
